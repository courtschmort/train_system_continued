...
--
-- Name: cities_trains; Type: TABLE; Schema: public; Owner: Guest
--
...
ALTER TABLE public.cities_trains OWNER TO "Guest";
...
ALTER TABLE public.cities_trains_id_seq OWNER TO "Guest";
...
--
-- Name: cities_trains id; Type: DEFAULT; Schema: public; Owner: Guest
--
...
COPY public.cities_trains (id, city_id, train_id) FROM stdin;
\.
...
--
-- Name: cities_trains cities_trains_pkey; Type: CONSTRAINT; Schema: public; Owner: Guest
--
